classdef tryrrt2
    ...
    properties
        ...
        %up path is best easy
        %obs = {[25 25;32 60];[47 45;55 75];[65 25;75 55]};   
        %middle path is best ,easy find
        %obs = {[25 15;32 50];[47 50;55 80];[65 25;75 55]};
        obs={[45 37;55 72];[45 15;55 34]};
        start=[10 50];
        goal=[90 50];
        Ta=[];
        Tb=[];
