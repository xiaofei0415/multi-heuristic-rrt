    ...
    methods
        ...
        function plot(obj)
            ...
            for i = 1:size(obj.obs,1)
                tem=obj.obs{i,1};
                plot([tem(1,1),tem(1,1),tem(2,1),tem(2,1),tem(1,1)], [tem(1,2),tem(2,2),tem(2,2),tem(1,2),tem(1,2)],'c-');%cyan
            end
        ...
        function soln = addNewSolution(obj,index1,index2)
            soln = obj.Xsoln;
            if abs(obj.Ta(1,1)-obj.start(1,1))<0.001 && abs(obj.Ta(1,2)-obj.start(1,2))<0.001
